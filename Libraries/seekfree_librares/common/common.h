...
//定义将代码放在ITCM的方式
    ...
    #define AT_ITCM_SECTION(var) var @"ITCM_NonCacheable"
    #define AT_ITCM_SECTION_ALIGN(var, alignbytes) SDK_PRAGMA(data_alignment = alignbytes) var @"ITCM_NonCacheable"
    #define AT_ITCM_SECTION_INIT(var) var @"ITCM_NonCacheable.init"
    #define AT_ITCM_SECTION_ALIGN_INIT(var, alignbytes) SDK_PRAGMA(data_alignment = alignbytes) var @"ITCM_NonCacheable.init"

#elif(defined(__CC_ARM) || defined(__ARMCC_VERSION))
    #define AT_ITCM_SECTION(var) __attribute__((section("ITCM_NonCacheable"), zero_init)) var
    #define AT_ITCM_SECTION_ALIGN(var, alignbytes) \
        __attribute__((section("ITCM_NonCacheable"), zero_init)) __attribute__((aligned(alignbytes))) var
