 ...
 * @param base FLEXSPI peripheral base address.
 */
AT_NONCACHEABLE_SECTION_INIT(static inline void FLEXSPI_SoftwareReset(FLEXSPI_Type *base))
{
 ...
 */
AT_NONCACHEABLE_SECTION_INIT(static inline bool FLEXSPI_GetBusIdleStatus(FLEXSPI_Type *base))
{
