...
void mpu6050_self1_check(void)
{
    ...
    simiic_write_reg(MPU6050_DEV_ADDR, SMPLRT_DIV, 0x01);   //500HZ采样率
    while(0x01 != simiic_read_reg(MPU6050_DEV_ADDR, SMPLRT_DIV,SIMIIC))
    {
        //卡在这里原因有以下几点
...
void mpu6050_init(void)
{
    ...
    mpu6050_self1_check();
    simiic_write_reg(MPU6050_DEV_ADDR, PWR_MGMT_1, 0x00);	//解除休眠状态
    simiic_write_reg(MPU6050_DEV_ADDR, SMPLRT_DIV, 0x01);   //0x07:125HZ采样率  0x01:500HZ采样率 
    simiic_write_reg(MPU6050_DEV_ADDR, MPU6050_CONFIG, 0x04);       
    simiic_write_reg(MPU6050_DEV_ADDR, GYRO_CONFIG, 0x18);  //2000
    simiic_write_reg(MPU6050_DEV_ADDR, ACCEL_CONFIG, 0x00); //0x10:8g  0x00:4g
